        ...
        <div class="col-xl-12">
            ...
            <div class="card easion-card">
                <div class="card-body ">
                    <div class=" row">
                        <div class="col-md-4"> 
                            <form action="dashboard/table/update" method="post">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <input type="num" name="id" hidden value="<?=$table['id']?>">
                                        <label for="inputEmai">Số bàn</label>
                                        <input name="table_num" type="table_num" class="form-control" id="inputEmai" placeholder="số bàn" required value="<?=$table['table_num']?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Số người</label>
                                        <input name="capacity" type="capacity" class="form-control" placeholder="số người" required value="<?=$table['capacity']?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select name="floor" id="floor" class="floor" >
                                            ...
                                            <option value="<?= $floor['floor']?>" <?= $table['floor'] == $floor['floor']? 'selected' : '' ?>><?=$floor['floor']?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="col" id="col" type="table_num" class="form-control" placeholder="số cột" required readonly value="<?=$table['col']?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Số hàng</label>
                                        <input name ="row" id="row" type="capacity" class="form-control" placeholder="số dòng" required readonly value="<?=$table['row']?>">
                                    </div>
                                </div>
