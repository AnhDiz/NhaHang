                            ...
                            <div class="login-box">
                                <div class="card">
                                    ...
                                    <div class="card-body login-card-body">
                                        <form id="myForm" action="<?= base_url('login/authenticate') ?>" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <button onclick="submitForm()" class="btn btn-primary btn-block">đăng nhập</button>
                                            </div>
                                            <div class="col-4">
                                                <a href="dang_ky"><button class="btn btn-primary btn-block">Đăng ký</button></a>
                                            </div>
                                        </div>
                                        <p class="mb-1">
