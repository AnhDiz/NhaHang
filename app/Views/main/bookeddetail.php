...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Reservation Start -->
        <div class="container-xxl py-5 px-0 wow fadeInUp" data-wow-delay="0.1s" style="height:750px">
            <div class="row g-0">
                <div class="col-md-8 bg-info" style="height: 630px">
                    <div class="row">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input name="table_num" id="table_num" class="form-control"  type="text" value="<?=$detail['table_num']?>" readonly>
                                        <label for="table_num"> Bàn số </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input name="floor" type="text" value="Tầng <?=$detail['floor']?>" readonly>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="request" class="form-control" placeholder="Yêu cầu" id="message" style="height: 100px"><?= htmlspecialchars($detail['request'])?></textarea>
                                        <label for="message">Yêu cầu</label>
                                    </div>
                                </div>
                                <input type="text" name="row" id="row" hidden value="<?=$detail['row']?>">
                                <input type="text" name="col" id="col" hidden value="<?=$detail['col']?>">
                                <input type="checkbox" name="status_cf">
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Chỉnh sửa</button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        $(document).ready(function(){
            let tableNum = $("#table_num").val();
            $(`button[data-id="${tableNum}"]`).addClass("bg-info");
        });
